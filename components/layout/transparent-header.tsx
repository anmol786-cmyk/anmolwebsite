          ...
          <div className="hidden xl:flex flex-col gap-2">
            <div className="grid grid-cols-12 items-center h-24 gap-3">
              ...
              <div className="col-span-4 flex justify-between items-center px-2">
                <TransparentNavLink href="/special-order" isTransparent={isTransparent}>Catering</TransparentNavLink>
                <TransparentNavLink href="/lunch-buffet-in-stockholm" isTransparent={isTransparent}>Lunch Buffet</TransparentNavLink>
                <TransparentNavLink href="/weekend-brunch-buffet" isTransparent={isTransparent}>Weekend Brunch</TransparentNavLink>
                <MenuNavDropdown
                  categories={categories}
                  className={cn(isTransparent && "!text-white hover:!text-primary")}
                />
              </div>
