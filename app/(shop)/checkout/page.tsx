...
export default function CheckoutPage() {
  ...
  const steps = [
    ...
    { id: 'shipping-method', label: 'Delivery', completed: !!shippingMethod },
        ...
        {!loadingMinimum && minimumOrderAmount > 0 && !meetsMinimum && (
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              ...
              <p className="mt-1">
                The minimum order amount is {formatPrice(minimumOrderAmount, 'SEK')}.
                Your current cart total is {formatPrice(cartTotal, 'SEK')}.
                Please add {formatPrice(minimumOrderAmount - cartTotal, 'SEK')} more to proceed.
              </p>
            </AlertDescription>
          </Alert>
        )}
