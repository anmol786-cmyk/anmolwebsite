              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="text-align: center; padding-bottom: 20px;">
                    ...
                    <p style="margin: 5px 0; color: #666666; font-size: 13px;">
                      📞 <a href="tel:${restaurantConfig.phone.replace(/\s/g, '')}" style="color: #8B1538; text-decoration: none;">${restaurantConfig.phone}</a>
                    </p>
                    <p style="margin: 5px 0; color: #666666; font-size: 13px;">
                      ✉️ <a href="mailto:${restaurantConfig.email}" style="color: #8B1538; text-decoration: none;">${restaurantConfig.email}</a>
                    </p>
                  </td>
                </tr>
                <tr>
