...
function getBuffetInfo(): KnowledgeBaseResponse {
    return {
        answer: `We offer two buffet options:\n\n**Lunch Buffet** - ${brandConfig.hours.lunch}. [Learn more](/lunch-buffet-in-stockholm)\n\n**Weekend Brunch** - ${brandConfig.hours.weekend}. [Learn more](/weekend-brunch-buffet)`,
        confidence: 'high',
        category: 'buffet'
    };
}
